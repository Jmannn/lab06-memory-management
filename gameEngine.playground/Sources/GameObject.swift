...
open class GameObject {
    ...
    weak var scene: Scene? //this is correct
    ...
    */
    ...
    init() {
        print("GameObject(\(Unmanaged.passUnretained(self).toOpaque())) init.")
    }
    ...
    */
    public final func addChild(object: GameObject) {
        ...
        // scene
        self.scene?.registerGameObject(object: object)
    }
    ...
    */
    open func collidedWith(other: GameObject) {
    ...
    deinit {
        ...
        */
        ...
        print("GameObject(\(Unmanaged.passUnretained(self).toOpaque())) deinit.")
    }
